...
export class WorkspaceAlreadyExists extends AppError {
  constructor(message: string = "Workspace ALready Exists") {
    super(message, 409);
  }
}

export class WorkspaceDoesntExist extends AppError {
  constructor(message: string = "Workspace deosnt Exist") {
    super(message, 404);
  }
}
